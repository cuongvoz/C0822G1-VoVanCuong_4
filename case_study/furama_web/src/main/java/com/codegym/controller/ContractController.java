...
public class ContractController {
    ...
    public String getHome(Model model) {
      ...
      model.addAttribute("customerList",iCustomerService.findTo());
      model.addAttribute("employeeList",iEmployeeService.findAll());
      model.addAttribute("facilityList",iFacilityService.findTo());
    ...
    public String getAttachFacility(RedirectAttributes redirectAttributes, @PathVariable("id") int id) {
        redirectAttributes.addFlashAttribute("listAttachFacilityOf",iAttachFacilityService.findById(id));
